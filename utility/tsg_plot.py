...
def model_log_save(model, batch_size, window_size, epochs, pred, Y_test_sequenced, modelpath):
...
def plot_predictions(pred, Y_test_sequenced, modelpath, savefigure = True):
